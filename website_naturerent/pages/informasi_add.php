...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($formErrors)) {
        ...
        $result = $repo->createInformasi($formValues['title'], $formValues['description']);
        ...
        $formErrors[] = 'Informasi gagal disimpan. Periksa koneksi atau izin database.';
    }
}
...
<section class="content-card add-user-card">
    <form class="add-user-form" method="POST" action="index.php?page=informasi&action=add">
        <div class="add-user-body">
            <div class="form-intro">
                ...
                <div>
                    ...
                    <p>Lengkapi informasi baru untuk ditampilkan di aplikasi</p>
                </div>
            </div>
